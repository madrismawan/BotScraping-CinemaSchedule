...
def main():
    URL = 'https://jadwalnonton.com/bioskop/di-bali/denpasar-cineplex-bali.html'
...
#         database="db-bioskop"
    ...
    sql = "INSERT INTO dpscineplex (judul, genre,harga,waktu,tanggal) VALUES (%s,%s,%s,%s,%s)"
...
schedule.every().day.at("20:08").do(main)
